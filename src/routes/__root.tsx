...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "StoryNest — A quiet workspace for novelists" },
      {
        name: "description",
        content:
          "StoryNest is an AI-powered writing workspace for novelists. Draft, organize, and rewrite with a focused three-pane editor and an intelligent assistant.",
      },
      { name: "author", content: "StoryNest" },
      { property: "og:title", content: "StoryNest — A quiet workspace for novelists" },
      {
        property: "og:description",
        content:
          "Draft, organize, and rewrite your novel with a focused editor and an intelligent AI writing partner.",
      },
